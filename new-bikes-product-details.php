	...
	<!--- Header Area End --->
		<head>
		 ...
		 <title>New Bikes | MyAutoCart</title>        
...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="new_bikes_product_details_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3 hidden>Buy New Bikes</h3>
                    <ul>
                        <li><a href="#" hidden>Home</a></li>
                        <li><a href="#" hidden>Shop</a></li>
                        <li class="current" hidden><a href="#">Buy New Bikes</a></li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <div class="product_table_details">
                             <div class="table-responsive-md">
						       ...
						       <table style="width:100%" class=""> 
                                ...
                                <tr>
								  <td><?php echo $Fpd['bhp']; ?></td>								 
								  <td><?php echo $Fpd['speedometer']; ?></td> 
								  <td><?php echo $Fpd['fuel_capacity'];?> L</td>								 
								  <td><?php echo $Fpd['engine_capacity']; ?> CC</td>
	            ...
	            if($PId!=$_REQUEST['pid']){											  
					  ...
					  <?php } } ?>					                                                                    
							    ...
							    <nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                     <li class="page-item next"><a class="page-link" href="new-bikes-product-detailss.php?page=<?= $Previous; ?>&pid=<?php echo $_REQUEST['pid']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="new-bikes-product-details.php?page=<?= $i; ?>&pid=<?php echo $_REQUEST['pid']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="new-bikes-product-details.php?page=<?php echo $Next; ?>&pid=<?php echo $_REQUEST['pid']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>							
