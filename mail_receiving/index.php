...
<body>
	...
	//$connection=imap_open("{pop.gmail.com:995/pop3/ssl}","kumaresan.vertex@gmail.com","Vertex!2345") or die('Cannot connect to Gmail: ' . imap_last_error());   

   $connection = imap_open('{imap.gmail.com:993/imap/ssl}INBOX', 'kumaresan.vertex@gmail.com', 'Vertex!2345') or die('Cannot connect to Gmail: ' . imap_last_error());
