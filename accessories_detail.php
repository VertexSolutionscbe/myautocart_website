...
<!--- Header Area End --->
		<head>
		 ...
		 <title>Detailing Equipments Product Details | MyAutoCart</title>        
...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="car_accessories_detail_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Buy Cars Accessories</h3>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Shop</a></li>
                        <li class="current"><a href="accessories.php">Accessories</a></li>
                    </ul>
                </div>
            </div>
        </section>
		...
		<?php
		  ...
		  $Fpd=mysqli_fetch_array($Epd);
			 ...
			 $tv1="SELECT * FROM tbl_product_specifications WHERE product_id='".$FEpv['product_id']."'";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="product_details_text">
                            ...
                            <h3 color="Red"><?php echo $FEts['segment']; ?></h3>
							...
							<div class="table-responsive-md">
						       ...
						       <table style="width:100%; font-family: Arial; font-size:18px;" class="table-bordered table-striped" > 
				                	<?php    
									if($FEtv1['spec_1']=='' OR $FEtv1['spec_1']=='null' ){ ?>
							         <tr></tr>
						              <?php }else{?>		    
								<tr> <td><b>Available For </b><?php echo $FEtv1['spec_1']; ?></td></tr>
									  <?php }?>
									  <?php    
...
for ($x = 0; $x < $arrlength; $x++) {
   $arr2[$x]."<br>";
   	            ...
   	            $spv="select * from tbl_products where  MATCH (product_title) AGAINST ('$arr2[$x]') AND category_id='17' ";
                ...
                <div class="related_product_inner">
                    ...
                    <div class="row">
					  ...
					  //$spv="select * from tbl_vendor_products where product_id='".$_REQUEST['pid']."'";
					   $spv="select * from tbl_products where MATCH (product_title) AGAINST ('$id') AND category_id='17'";
					  $Espv=mysqli_query($conn,$spv);
					  ...
					  ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                  <a href="detailing_equipments_product_details.php?pid=<?php echo $resultProducts["product_id"]; ?>"><img src="<?php echo $resultProducts["photo"]; ?>" style="height:220px" alt=""></a>									
                                    <h5 class="new" hidden>Service</h5>									
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                      <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                      <li><a class="add_cart_btn" href="detailing_equipments_product_details.php?pid=<?php echo $resultProducts["product_id"]; ?>">View</a></li>
