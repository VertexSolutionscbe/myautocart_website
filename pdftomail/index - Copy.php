...
mysql_connect("","testtaiba","!^hb*tM1!c03");
 mysql_select_db("testtaiba"); 
...
$connect = new PDO("mysql:host=localhost;dbname=testtaiba", "testtaiba","!^hb*tM1!c03");
...
$output.='<tr>
<td  align="LEFT" colspan="5"style="font-size:18px">Supplier Name  : <B>'.$epm['sname'].'</B><BR/>
...
<tr align="left">
<td colspan="2"></td>
<td align="left" colspan="10" style=" height:20px" ><span style="font-size:20px">SPARE DETAILS</span></td>
</tr>
<tr align="left">
<td ></td>
<td ><b>S:No</b></td>
