...
function fetch_customer_data($conn)
{
	$i=0;
     ...
     $rd="SELECT * FROM tbl_invoice_details where confirm_order_id='".$_REQUEST['coid']."'";
     ...
     /* $cp="SELECT * FROM `tbl_confirm_orders` WHERE customer_id='".$Find['customer_id']."'";
...
<tr>
<td align="left" width="350"><B>Details<B><BR/>'.$Fcn['f_name'].'<BR/>'.$Fcn['billing_address'].'<BR/>'.$Fcn['mobile'].'<BR/>'.$Fcn['email'].'</td>
<td>Invoice No<br/>Order No<br/>DATE</td>
<td>: <br/>:<br/>:</td>
<td>'.$EFrd['inv_no'].'<br/>'.$EFrd['OrderNo'].'<br/>'.date("d-m-Y", strtotime($EFrd['order_date'])).'</td>
</tr>
</table>
</td>
</tr>';

$output.='<tr><td align="left"  height="50px"><b>Billing Details :</b></td></tr>
<tr>
<td>
...
<td bgcolor="#000000" align="center"><FONT COLOR="FFFFFF">Product Name</FONT></td>
<td bgcolor="#000000" align="center"><FONT COLOR="FFFFFF">Rate</FONT></td>
<td bgcolor="#000000" align="center"><FONT COLOR="FFFFFF">Qty</FONT></td>
...
<td bgcolor="#FFCCCC">'.$product_title.'</td>
<td bgcolor="#FFCCCC" align="right">'.$amount.'</td>
<td bgcolor="#FFCCCC" align="center">'.$qty.'</td>
<td bgcolor="#FFCCCC" align="center">'.$Fs1['cgst'].'</td>
<td bgcolor="#FFCCCC" align="center">'.$Fs1['igst'].'</td>
<td bgcolor="#FFCCCC" align="center">'.$Fs1['sgst'].'</td>
<td bgcolor="#FFCCCC" align="right">'.$amount.'</td> 
</tr>';
//}
$i=5-$n;
...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br/>
			<form method="post">
				<input type="submit" name="action" class="btn btn-danger" value="Send Invoice To Mail" /><?php echo $message; ?>
			</form>
			<br/>
			<?php
