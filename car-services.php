	  ...
	  <head>
        ...
        <?php
		 $tg="SELECT * FROM tbl_seo_tags WHERE webpage='car-services.php'";
      ...
      <!--- Heade Area End --->  
        ...
        <section class="carwash_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Car Wash Services in India</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li hidden><a href="#">Car Services</a></li>
                        <li class="current"><a href="#">Car Wash Services</a></li>
                    </ul>
                </div>
            </div>
        </section>
							  ...
							  <div class="showing_fillter">
                               <div class="row m0">
								...
								$FEsmm=mysqli_fetch_array($Esmm);																	
								  ...
								  // OR vehicle_segment_id='".$_REQUEST['sgid']."'
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="car-services.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="car-services.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="car-services.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
