	...
	<!--- Header Area End --->
	  ...
	  <head>
        ...
        <?php
		 $tg="SELECT * FROM tbl_seo_tags WHERE webpage='used-bikes.php'";
      ...
      <!--- Heade Area End --->	
        ...
        <section class="used_bikes_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Used Bikes in india</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li hidden><a href="#">Used Bikes</a></li>
                        <li class="current"><a href="#">Used Bikes</a></li>
                    </ul>
                </div>
            </div>
        </section>
						...
						<div class="alert alert-success alert-dismissible" role="alert">
							...
							Item Added in your Wish list !
								   ...
								   ?>   
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
                                                <a href="used-bikes-product-details.php?pid=<?php echo $result5; ?>"><img src="<?php echo $result1; ?>" alt="<?php echo $Fpl['img_alt']; ?>" title="<?php echo $Fpl['img_title']; ?>" style="height:180px" width="100%"></a>
                                                <h5 class="sale"><?php echo $Fpl['status']; ?></h5>
                                            </div>
                                            <div class="l_p_text">
                                                <ul>
                                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                                    <li><a class="add_cart_btn" href="used-bikes-product-details.php?pid=<?php echo $result5; ?>&sid=<?php echo $segment1; ?>&cid=<?php echo 1; ?>">View</a></li>
                                                      <li>
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="used-bikes.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="used-bikes.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="used-bikes.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
                                        ...
                                        <li class="nav-item dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
											  ...
											  <?php if($fctgry['category_name']=='New Cars'){ ?>
                                                <li class="nav-item"><a class="nav-link" href="used-bikes.php?cid=<?php echo $fctgry['category_id']; ?>&cname=<?php echo $fctgry['category_name']; ?>"> <?php echo $fctgry['category_name']; ?></a></li>
											  <?php } ?>
                                    ...
                                    <ul class="navbar-nav">                                        
                                        <li class="nav-item dropdown">
											...
											<?php
									         ...
									         ?>                                              												
												 <?php if($FEbr['id']==123){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">HERO</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==124){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">HONDA</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==125){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">BAJAJ</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==126){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">KTM</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==127){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">TVS</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==128){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">SUZUKI</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==129){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">APRILLIA</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==130){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">YAMAHA</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==131){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">KAWASAKI</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==132){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">ROYAL ENFIELD</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==133){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">BENELLI</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==134){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">BMW</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==135){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">DUCATI</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==136){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">JAWA</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==137){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">MAHINDRA</a></li>
									             <?php } ?>
												 <?php if($FEbr['id']==138){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-bikes.php?bid=<?php echo $brand_id; ?>&bname=<?php echo $brand_name; ?>">VESPA</a></li>
									             <?php } ?>
											     <?php }
												 ?>									             									   									             												
                                            </ul>
                                    ...
                                    <div class="verticalCarousel">
                                        ...
                                        <ul class="verticalCarouselGroup vc_list">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <a href="used-bikes-product-details.php?pid=<?php echo $resultFProducts["product_id"]; ?>"><img src="<?php echo $resultFProducts["photo"]; ?>" width="100px" height="70px" alt=""></a>
                                                    </div>
