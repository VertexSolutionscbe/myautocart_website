                        ...
                        <div class="carousel_top_h_inner">
                            ...
                            <div class="float-md-right">
                                ...
                                <ul class="account_list">							                                                
										<li><a href="#"> <span id="google_location_element"></span> <i class="fa fa-map-marker" aria-hidden="true"></i></a></li>							
...
//Start Find Location - Kumaresan K	
var x = document.getElementById("google_location_element");
...
var city=    response["address"]["state_district"]; //Coimbatore
var cityonly =city.replace(" district", "");
var display_name=response["display_name"]; 
x.innerHTML = cityonly ;
console.log(response);
console.log(city);
});     
}
//Stopn Find Location - Kumaresan K 
