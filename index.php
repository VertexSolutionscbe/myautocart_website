    ...
    <!--- Heade Area --->
	  <head>
		...
		<!-- <?php
		/*  echo $tg="SELECT * FROM tbl_seo_tags WHERE webpage='index.php'";
        ...
        <title>Mobile App Development | Car Wash Management Software | Service Station Management Software | Best Mobile App & Car Booking App Development Company - Vertex Solutions</title>
		<meta name="description" content="Vertex Solutions is a new-generation web design and industry software,Mobile App Development company in Coimbatore, India. We provide supreme-standard web development, Web Design,Mobile App Development, Car Booking App and SEO & Digital Marketing services at affordable cost.">		
                    ...
                    <div class="row row_disable">
                        <div class="col-lg-9 float-md-right">
                            ...
                            <div class="sidebar_main_content_area">							                                        								                                    
									 ...
									 <div class="row">
									  ...
									  <div class="col-md-1 padding-0" style="margin-top:-5px;margin-left:-10px">									
                                       <span class="input-group-btn left">
                                         <button class="btn btn-secondary" type="submit" id="search" style="height:60px; margin:5px 0px 0px 0px; border-radius: 0px 7px 7px 0px;"><i class="icon-magnifier icons"></i></button>									   
                                       </span>										                                          
									  </div>
									 </div>
                                     <div>	
								...
								$imageurl="admin/dist/uploads/banners/";
								?>
                                <div class="main_slider_area">                                    
									<div id="home_box_slider" class="rev_slider" data-version="5.3.1.6">
                                        <ul>
                                            ...
                                            <!-- MAIN IMAGE -->
                                            <img src="<?php echo $imageurl.$resultBanners["php_banner1"]; ?>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                                            <!-- LAYERS -->
                                                <!-- LAYERS -->
                                            ...
                                            <!-- MAIN IMAGE -->
                                            <img src="<?php echo $imageurl.$resultBanners["php_banner2"]; ?>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                                            <!-- LAYERS -->
                                                <!-- LAYERS -->
                                            ...
                                            <!-- MAIN IMAGE -->
                                            <img src="<?php echo $imageurl.$resultBanners["php_banner3"]; ?>"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina>
                                            <!-- LAYERS -->
                                                <!-- LAYERS -->
									...
									<h1 style="font-size:20px;" align="center" hidden> Buy Used cars online, Book Car Service online, Buy Car Service Equipment online </h1>
                                </div>
                                ...
                                <div class="fillter_home_sidebar">
                                    ...
                                    <?php															                                       									     																											                                       
                                      $qp="select * from  tbl_products where category_id='2' AND product_status='Active' order by product_id limit 0,6";
                                     ...
                                     <div class="row">
										...
										<div class="col-lg-4 col-sm-6">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                   <a href="product-details.php?pid=<?php echo $resultProducts["product_id"]; ?>"><img src="<?php echo $resultProducts["photo"]; ?>"  width="100%"  style="height:180px" alt=""></a>
													<?php 
												if($resultProducts["product_sales"]==0)
												{
												?>
                                                <h5 class="new" hidden>Sale</h5>
								...
								<div class="fillter_home_sidebar">
                                    ...
                                    <?php																										                                       									     
								     $qp1="select * from  tbl_products where category_id='17' AND product_status='Active' order by product_title limit 4,6";
                                    ...
                                    <div class="categories_product_area">
                                     <div class="row">
										...
										<div class="col-lg-4 col-sm-6">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                  <a href="detailing_equipments_product_details.php?pid=<?php echo $resultProducts1["product_id"]; ?>"><img src="<?php echo $resultProducts1["photo"]; ?>" style="height:180px" alt=""></a>
													<?php 
									...
									?>
										...
										<a href="wash_equipments_product_details.php?pid=<?php echo $resultEquipements["product_id"]; ?>">
                                            <div class="from_blog_item">
                                                ...
                                                <img class="img-fluid" src="<?php echo $resultEquipements["photo"]; ?>" alt="">
								...
								<div class="fillter_home_sidebar">
                                    ...
                                    <?php																										                                       									     
                                     $qp12="select * from  tbl_products where category_id=14 order by product_title limit 0,3";
                                    ...
                                    <div class="categories_product_area">
                                     <div class="row">
										...
										<div class="col-lg-4 col-sm-6">
                                            <div class="l_product_item">
                                                <div class="l_p_img">
                                                   <a href="wash_equipments_product_details.php?pid=<?php echo $resultProducts12["product_id"]; ?>"><img src="<?php echo $resultProducts12["photo"]; ?>" width="100%" style="height:180px" alt=""></a>
													<?php 
                            ...
                            <div class="left_sidebar_area">							    
							    <aside class="l_widget l_categories_widget">
									...
									<?php if($FEct['category_name']=='New Bikes') { ?>
                                       <li><a href="new-bikes.php?cid=<?php echo $FEct['category_id'];?>&cname=<?php echo $FEct['category_name'];?>"><?php echo $FEct['category_name']; ?></a></li>
									<?php } ?>
									<?php if($FEct['category_name']=='Used Bikes') { ?>
									  <li><a href="used-bikes.php?cid=<?php echo $FEct['category_id'];?>&cname=<?php echo $FEct['category_name'];?>"><?php echo $FEct['category_name']; ?></a></li>
									<?php } ?>
									...
									<?php if($FEct['category_name']=='Detailing Equipments') { ?>
									 <li><a href="car-detailing-equipments.php?cid=<?php echo $FEct['category_id'];?>&cname=<?php echo $FEct['category_name'];?>"><?php echo $FEct['category_name']; ?></a></li>
								    <?php } ?>									
									</ul>
									<?php } ?>									 
                                </aside>								   
                                ...
                                <aside class="l_widget l_feature_widget">
                                    <div class="verticalCarousel">
                                        ...
                                        //Listing Feature Products Start
                                          $qfp="select * from  tbl_products where product_status='Active' AND category_id='2' order by product_id desc limit 5,15";
								...
								<aside class="l_widget l_news_widget" hidden>
                                    <h3 hidden>Summer Hot Sale</h3>
                                    <p hidden>Premium 700 Product , Titles and Content Ideas</p>
                                    <a class="discover_btn" href="used-cars.php" hidden>shop now</a>
                                </aside>
                            </div>
                        </div>
                    </div>
