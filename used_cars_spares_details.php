...
<!--- Header Area End --->
		<head>
		 ...
		 <title>used_cars_spares_details | MyAutoCart</title>        
...
for ($x = 0; $x < $arrlength; $x++) {
   $arr2[$x]."<br>";
   	            ...
   	            $spv="select * from tbl_products where  MATCH (product_title) AGAINST ('$arr2[$x]') AND category_id='15' ";
            ...
            <div class="container">
                <div class="related_product_inner">
                    ...
                    <div class="row">
					  ...
					  $spv="select * from tbl_products where  MATCH (product_title) AGAINST ('$id') AND category_id='15'";
					  $Espv=mysqli_query($conn,$spv);
					  ...
					  ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                  <a href="used_cars_spares_details.php?pid=<?php echo $resultProducts["product_id"]; ?>"><img src="<?php echo $resultProducts["photo"]; ?>" style="height:220px" alt=""></a>									
                                    <h5 class="new" hidden>Service</h5>									
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                      <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                      <li><a class="add_cart_btn" href="used_cars_spares_details.php?pid=<?php echo $resultProducts["product_id"]; ?>">View</a></li>
