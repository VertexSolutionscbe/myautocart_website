...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="usedbikes_product_details_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Buy Used Bikes</h3>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Shop</a></li>
                        <li class="current"><a href="#">Buy Used Bike</a></li>
                    </ul>
                </div>
            </div>
        </section>
                                  ...
                                  <div class = "container">
                                    ...
                                    <div class = "outer-icons">
                                      <i class = "one fa fa-google-plus" hidden> </i>
                                       <a href="https://www.facebook.com/sharer/sharer.php?u=https://myautocart.com/used-bikes-product-details.php?pid=<?php echo $_REQUEST['pid']; ?>" target="_blank"><i class = "two fa fa-facebook-official"> </i></a>
                                       <a href="https://twitter.com/home?status=https://myautocart.com/used-bikes-product-details.php?pid=<?php echo $_REQUEST['pid']; ?>" target="_blank"><i class = "three fa fa-twitter"> </i></a>								   
                            ...
                            <div class="product_table_details">
                             <div class="table-responsive-md">
						       ...
						       <table style="width:100%" class="table-bordered table-striped"> 
							    <tr>
								  <th><img src="img/icon/power.png" alt="power" title="Power"></th>
								  <th><img src="img/icon/speedmeter.png" alt="speedometer" title="Speedometer"></th>
								  <th><img src="img/icon/fuel-tank.png" alt="fuel tank capacity" title="Fuel tank Capacity"></th> 								  								                                   
                                  <th><img src="img/icon/engine.png" alt="engine" title="Bike Engine Capacity"></th>
                                  <th><img src="img/icon/abs.png" alt="" title=""></th>								  
								</tr>
                                <tr>
								  <td><?php echo $Fpd['dsp']; ?></td>								 
								  <td><?php echo $Fpd['speedometer']; ?></td> 
								  <td><?php echo $Fpd['fuel_capacity'];?></td>								 
								  <td><?php echo $Fpd['engine-capacity']; ?></td>
                                  <td><?php echo $Fpd['abs']; ?></td>								  
								</tr>
                              </table>						 						 
                             </div>						
                            </div>
                    ...
                    <div class="row">
					  ...
					  ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                  <a href="used-bikes-product-details.php?pid=<?php echo $resultProducts["product_id"]; ?>&sid=<?php echo $resultProducts["body_type"]; ?>&cid=<?php echo $resultProducts["category_id"]; ?>"><img src="<?php echo $resultProducts["photo"]; ?>" style="height:220px" alt=""></a>									
                                    <h5 class="new" hidden>Service</h5>									
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                      <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                      <li><a class="add_cart_btn" href="used-bikes-product-details.php?pid=<?php echo $resultProducts["product_id"]; ?>&sid=<?php echo $resultProducts["body_type"]; ?>&cid=<?php echo $resultProducts["category_id"]; ?>">View</a></li>
					  ...
					  <?php } } ?>					                                                                    
							    ...
							    <nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                     <li class="page-item next"><a class="page-link" href="used-bikes-product-details.php?page=<?= $Previous; ?>&pid=<?php echo $_REQUEST['pid']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="used-bikes-product-details.php?page=<?= $i; ?>&pid=<?php echo $_REQUEST['pid']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="used-bikes-product-details.php?page=<?php echo $Next; ?>&pid=<?php echo $_REQUEST['pid']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>							
