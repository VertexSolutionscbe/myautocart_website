						...
						<div class="alert alert-success alert-dismissible" role="alert">
							...
							Item Added in your Wish list !
                                        ...
                                        <div class="l_product_item">
                                            ...
                                            <div class="l_p_text">
                                                <ul>
                                                    ...
                                                    <li><a class="add_cart_btn" href="new-cars-product-details.php?pid=<?php echo $result5; ?>&sid=<?php echo $segment1; ?>&cid=<?php echo 1; ?>">View</a></li>
                                                      <li>
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="new-cars.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="new-cars.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="new-cars.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
