...
$imageurl="admin/dist/uploads/";
	 ...
	 $valid = 1;
	    ...
	    $statement = $pdo->prepare("INSERT INTO tbl_newsletter (e_mail) VALUES (?)");
		$statement->execute(array($_POST['e_mail']));
		  
	   header("location: newsletter_finished.php");
	   }
...
function ClearFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="newsletter_finished_banner_area">
            <div class="container">
...
?>
<tr>
<td colspan="5" ><div id="addmsg" style="color: green">Thanks for Subscribing With Our Newsletter...</div></td>
</tr>
<?php } ?>									
