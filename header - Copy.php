                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
									...
									<li class="nav-item dropdown submenu">
                                        ...
                                        <ul class="dropdown-menu">
										 ...
										 <?php }if($FEct['category_name']=='Special Package Offers') {  ?>
                                            <li class="nav-item"><a class="nav-link" href="special_package_offers.php?cid=<?php echo $FEct['category_id'];?>&cname=<?php echo $FEct['category_name'];?>&city=<?php echo $City;?>"> <?php echo $FEct['category_name'];?></a></li>                                                                                     
                                    ...
                                    <div class="tp-caption tp-resizeme third_btn" 
                                                        ...
                                                        <a class="checkout_btn" href="selfDrining_add.php">SELF DRIVING</a>
                                    </div>	
								</ul>
