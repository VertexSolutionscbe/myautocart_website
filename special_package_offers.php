 <!--- Header Area --->
		...
		<head>
          ...
          <?php
		   $tg="SELECT * FROM tbl_seo_tags WHERE webpage='car_detailing.php'";
                        ...
                        <div class="col-lg-9">
							...
							$i=0;
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="special_package_offers.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="special_package_offers.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="special_package_offers.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
