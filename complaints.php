	  ...
	  <head>
        ...
        <?php
		 $tg="SELECT * FROM tbl_seo_tags WHERE webpage='complaints.php'";
							  ...
							  <div class="showing_fillter">
                               <div class="row m0">
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="complaints.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="complaints.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>&sgid=<?php echo $_REQUEST['sgid']; ?>&city=<?php echo $_REQUEST['city']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="complaints.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>&sgid=<?php echo $_REQUEST['sgid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
                                    ...
                                    <div class="verticalCarousel">
                                        ...
                                        <ul class="verticalCarouselGroup vc_list">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <a href="car_detailing_view.php?pid=<?php echo $resultFProducts["id"]; ?>&sid=<?php echo $resultFProducts["service_id"]; ?>&cid=<?php echo $resultFProducts["category_id"]; ?>&sgid=<?php echo $resultFProducts["vehicle_segment_id"]; ?>"><img src="<?php echo $resultFProducts["photo"]; ?>" width="100px" height="50px" alt=""></a>
                                                    </div>
