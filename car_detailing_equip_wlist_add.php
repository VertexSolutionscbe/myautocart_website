...
$query="INSERT INTO tbl_wishlist SET category_id=".$FEtp['category_id'].", product_id=".$FEtp['product_id'].", vendor_id=".$FEtp['vendor_id'].", vendor_product_id=".$FEtv['id'].", customer_id='".$_REQUEST['custid']."'";
$Equery=mysqli_query($conn,$query);
		
header ('location:car_detailing_equipments.php?cid=17&cname=Detailing Equipments');
?>