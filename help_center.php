		...
		<head>
		 ...
		 <title>Help Center | myautocart</title>      
		...
		<section class="help_center_banner_area">
            <div class="container">
        ...
        <section class="contact_area p_100">
            <div class="container">
                ...
                <div class="contact_title">
                    <h2>Get in Touch</h2>
                    <p>Get in touch with the experts to buy Used Cars, New Cars, Car Service Equipments Car Service bookings</p>
                </div>
				<div>&nbsp;</div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <p>198, 1st Floor, VKV Building Nehru Street,<br />Ramnagar, Coimbatore,<br/>Tamilnadu, India-641009.</p>                                                                                                
							</div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="tel:+919566969517">+91 9566969517</a>
                                <a href="tel:+914224377517">+91 422 4377517</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="mailto:sales@myautocart.com">sales@myautocart.com</a>
                                <a href="mailto:support@persuit.com" hidden>support@persuit.com</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="contact_form_inner" hidden>
                    <h3>Drop a Message</h3>
                    <form class="contact_us_form row" action="contactus_finished.php" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="form-group col-lg-12">
                            <button type="submit" value="submit" name="form1" class="btn update_btn form-control">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
