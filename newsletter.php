		...
		<head>
		 ...
		 <title>NEWS LETTER | MyAutoCart</title>       
		...
		<section class="newsletter_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3 hidden>NEWS LETTER</h3>
                    <ul hidden>
            ...
            <div class="container">
                ...
                <div class="col-lg-12">
                 <div class="contact_form_inner">
                    <form class="contact_us_form row" action="newsletter_finished.php" method="post" id="contactForm">
                        <div class="form-group col-lg-4">
						<label><b>E-MAIL : </b></label>
                            <input type="email" class="form-control" id="e_mail" name="e_mail" placeholder="Your Mail" required>
                        </div>
						
           
                        <div class="form-group col-lg-12">
                            <button type="submit" name="form1"  class="btn update_btn form-control">SUBSCRIBE</button>
                        </div>
                    </form>
                 </div>
			   </div>	
