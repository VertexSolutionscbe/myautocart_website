    ...
    // location.replace("register.php")
     ...
     return false; 
		...
		<head>
		 ...
		 <title>Booked Service History | MyAutoCart</title>       
                                    ...
                                    <tbody>
                                        <?php																	
                                         if($_SESSION['customer_id']>0) 
										  ...
										  $sa="SELECT * FROM `tbl_service_appointment` WHERE customer_id='".$_SESSION['customer_id']."' order by appointment_id desc ";
