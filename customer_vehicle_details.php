	    ...
	    <?php 	 
		  ...
		  $FEapo=mysqli_fetch_array($Eapo);
		   ...
		   $gst_amount=$amount-($amount*(100/(100+$gst_per)));
		   
		   $actual_amount=$amount-$gst_amount;
		   
		   $total_amount=$actual_amount+$gst_amount;
	    ?>	
				   ...
				   <div class="form-group-control col-lg-3" >
                     ...
                     <div class="form-group-control col-lg-3" >
                      ...
                      <div class="form-group-control col-lg-3" >
						...
						<input type="text" class="form-control" id="s_amount" name="s_amount" value="<?php echo number_format($actual_amount,2); ?>" readonly required>
                     </div>	        
					 
					 <div class="form-group-control col-lg-3" >
						<label><b>GST % : </b></label>
						<input type="text" class="form-control" id="gst_per" name="gst_per" value="<?php echo $gst_per;  ?> % " readonly required>
                     </div>		 
					 <div class="form-group-control col-lg-3" >
						<label><b>GST Amount : </b></label>
						<input type="text" class="form-control" id="gst_amount" name="gst_amount" value="<?php echo number_format($gst_amount,2); ?>" readonly required>
                     </div>	 
					 
					 <div class="form-group-control col-lg-3" >
						<label><b> Amount : </b></label>
						<input type="text" class="form-control" id="total_amount" name="total_amount" value="<?php echo number_format($total_amount,2); ?>" readonly required>
                     </div>				 
					<div>&nbsp;</div>
                     <div class="form-group-control col-lg-3" >
						<label><b>Vehicle Number : </b></label>
