 <!--- Header Area --->
	  ...
	  <head>
        ...
        <?php
		 $tg="SELECT * FROM tbl_seo_tags WHERE webpage='special-package-offers.php'";
      ...
      <!--- Heade Area End --->
		  ...
		  <!-- Global site tag (gtag.js) - Google Analytics -->
            ...
            <script>
              ...
              $.ajax({
               type:'post',
               url:'aj_cardetailing_price_filter.php',// put your real file name 
        ...
        <section class="Special_Package_Offers_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Special Package Offers</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li hidden><a href="#">Car Services</a></li>
                        <li class="current"><a href="#">Special Package Offers</a></li>
                    </ul>
                </div>
            </div>
        </section>
		<!-- Full Page Video Background Header -->
	    <div class="wrapper" hidden>
          <video autoplay loop muted class="wrapper__video">
            <source src="img/video/washvid.mp4">
          </video>
         <div class="carousel-caption">
           <h2 class="animated fadeInLeft text-white">One Stop Solution For All Your Printing Needs</h1>		  
           <p class="animated fadeInUp banner_bttn"><a href="products.php" class="bttn bttn-transparent bttn-rounded bttn-large primary-btn d-inline-flex align-items-center"><span class="mr-10">View Products</span><span class="lnr lnr-arrow-right"></span></a></p>          		  
		 </div> 		  
        </div>		
	    <!-- End Banner Area -->
                    ...
                    <div class="row">
                        <div class="col-lg-9">
							...
							$i=0;
                                  ...
                                  {
									$spc="SELECT * FROM `tbl_packages` t1 LEFT JOIN tbl_vendor t2 ON t1.vendor_id=t2.vendor_id WHERE category='".$_REQUEST['cid']."' AND t2.city='".$_REQUEST['city']."' LIMIT $start, $limit";
								  }else {
										$spc="SELECT * FROM `tbl_packages` WHERE category='".$_REQUEST['cid']."' LIMIT $start, $limit";
																	}
								    $Espc=mysqli_query($conn,$spc);	
									
									$custCount =  mysqli_query($conn,$spc);
									...
									while($FEspc=mysqli_fetch_array($Espc))  {	 								      									  
									   
									        

									    $result=$FEspc['id'];
									   
									   $vs="SELECT * FROM tbl_segment WHERE id='".$FEspc['vehicle_segment']."'";
									   $Evs=mysqli_query($conn,$vs);
									   $FEvs=mysqli_fetch_array($Evs);
									   
									   
									   	$result1 ="SELECT count(t1.id) AS id FROM tbl_packages t1 LEFT JOIN tbl_vendor t2 ON t1.vendor_id=t2.vendor_id WHERE category='".$_REQUEST['cid']."' AND t2.city='".$_REQUEST['city']."'";
	                              ...
	                              $Next = $page + 1; 
									       ...
									       $svm12="SELECT count(t1.id) AS total_count_packages FROM tbl_packages t1 LEFT JOIN tbl_vendor t2 ON t1.vendor_id=t2.vendor_id WHERE category='".$_REQUEST['cid']."' AND t2.city='".$_REQUEST['city']."'";
                                           $Esvm12=mysqli_query($conn,$svm12);
                                           $FEsvm12=mysqli_fetch_array($Esvm12);
								   
                                           $total_count_pages= $pages;						  
	     	                               $total_count_packages=$FEsvm12['total_count_packages'];
						          ...
						          $i++;
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
                                                <a href="special_package_details_view.php?pid=<?php echo $FEspc['id']; ?>&sid=<?php echo $FEvs['id']; ?>"><img src="<?php echo $FEspc['photo']; ?>" alt="<?php echo $Fpl['img_alt']; ?>" title="<?php echo $Fpl['img_title']; ?>" style="height:180px"></a>
                                                <h5 class="new" hidden>New</h5>
                                            </div>
                                            <div class="l_p_text">
                                                <ul>
                                                  <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                                  <li><a class="add_cart_btn" href="special_package_details_view.php?pid=<?php echo $FEspc['id']; ?>&sid=<?php echo $FEvs['id']; ?>">View</a></li>
                                                 <!-- <li class="p_icon"><a href="car_detailing_wish_list_add.php?pid=<?php// echo $FEspc['id']; ?>&&custid=<?php// echo $_SESSION['customer_id']; ?>"><i class="icon_heart_alt"></i></a></li>     -->                                          
                                                
                                                  <li >
                                                     <a class="button one mobile button--secondary deactivate inactive" href="car_package_wish_list_add.php?pid=<?php echo $result; ?>&&custid=<?php echo $_SESSION['customer_id']; ?>">
												...
												<h4><?php echo $FEspc['package_name']; ?></h4>
                                                <h5><?php echo $FEvs['segment']; ?></h5>
                                                <h6> &#8377; <?php echo $FEspc['package_amount']; ?></h6>
                                            </div>
                                        </div>
                                    </div>
								 <?php } ?>					    								
								...
								<li>	<b>No of Packages :  <?php echo $total_count_packages;  ?></b></li>
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="special-package-offers.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="special-package-offers.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="special-package-offers.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
                                    ...
                                    <ul class="navbar-nav">                                                                                                                                                                                                     
                                        <li class="nav-item dropdown">
											...
											<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
		                                      ...
		                                      ?>
										      <?php if($FEtseg['id']=='1'){ ?>
                                                <li class="nav-item"><a class="nav-link" href="car_detailing.php?sgid=<?php echo $FEtseg['id']; ?>&sgname=<?php echo $FEtseg['segment']; ?>"> <?php echo $FEtseg['segment']; ?></a></li>
											  <?php } ?>
											  <?php if($FEtseg['id']=='2') { ?>
											    <li class="nav-item"><a class="nav-link" href="car_detailing.php?sgid=<?php echo $FEtseg['id']; ?>&sgname=<?php echo $FEtseg['segment']; ?>"> <?php echo $FEtseg['segment']; ?></a></li>
											  <?php } ?>
                                ...
                                <aside class="l_widget l_feature_widget">
                                    <div class="verticalCarousel">
                                        ...
                                        //Listing Feature Products Start
                                          $qfp="select * from  tbl_vendor_services where category_id='16' order by id desc limit 0 ,10";
