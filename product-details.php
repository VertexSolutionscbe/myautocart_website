...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="product_details_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Buy New and Used Cars</h3>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Shop</a></li>
                        <li class="current"><a href="#">Buy new and Used cars</a></li>
                    </ul>
                </div>
            </div>
        </section>
                            ...
                            <div class="product_table_details">
                             <div class="table-responsive-md">
						       ...
						       <table style="width:100%" class="table-bordered table-striped"> 
								 ...
								 <tr hidden><th>Vendor         </th> <td><?php echo $FEtv['vendor_name']; ?> <?php // echo $FEtv['vendor_id']; ?></td></tr>
								 <tr><th>Vendor         </th> <td><?php echo preg_replace("/(^.|.$)(*SKIP)(*F)|(.)/","*",$vendor_name); ?> </td></tr>
								 <tr hidden><th>Product Vendor </th> <td><?php echo $FEpv['id']; ?></td></tr>
                              </table>						 						 
                             </div>						
                            </div>
