 ...
 if (isset($_POST['submit'])){
  ...
  $logo           = $_POST['$logo'];
	 ...
	 $customer_id=mysqli_insert_id($conn);
		 ...
		 $query1="INSERT INTO user_create SET user_id='".$AUC."', financial_year='".$_SESSION['financial_year']."', user_name='".$contact_person."', company_name='".$customer_id."', branch_name='".$city."', password='".$password."', user_role='vendor',  photo='', email='".$email."', phone='".$contact_no."'"; 
	  ...
	  // uploading the photo into the main location and giving it a final name
        ...
        move_uploaded_file( $path_tmp, 'admin/dist/uploads/profile/'.$final_name);
		 ...
		 $query1="INSERT INTO user_create SET user_id='".$AUC."', financial_year='".$_SESSION['financial_year']."', user_name='".$contact_person."', company_name='".$id."', branch_name='".$city."', password='".$password."', user_role='vendor',  photo='".$final_name."', email='".$email."', phone='".$contact_no."'"; 
  	     $Equery1=mysqli_query($conn,$query1);
		 $idd=mysqli_insert_id($conn); exit;
							...
							<div class="billing_details">
                             <form class="billing_inner row" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-12 form-group">
                                   ...
                                   <input class="form-control" type="text" name="contact_no" pattern="^\d{10}$" placeholder="Mobile" required>
                                </div>
                                ...
                                <div class="col-lg-12 form-group">
                                    ...
                                    <input class="form-control" type="password" name="password" pattern="^(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=\S+$).{6,}$" placeholder="Password" required>
                                </div>
