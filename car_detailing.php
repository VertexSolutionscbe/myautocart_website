      ...
      <!--- Heade Area End ---> 
        ...
        <section class="car_detailing_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Car Detailing Services in India</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li hidden><a href="#">Car Services</a></li>
                        <li class="current"><a href="#">Car Detailing Services</a></li>
                    </ul>
                </div>
            </div>
        </section>
							  ...
							  <div class="showing_fillter">
                               <div class="row m0">
                                 ...
                                 if(isset($_REQUEST['cname']))
                                  {
		                           ...
		                           // $pl="SELECT tvs.*,ts.* FROM tbl_vendor_services tvs left join tbl_services ts on tvs.service_id=ts.id where category_id='".$_REQUEST['cid']."' OR vehicle_segment_id='".$_REQUEST['sgid']."' order by amount LIMIT $start, $limit";
                                   // $result1 ="SELECT tvs.*,ts.* FROM tbl_vendor_services tvs left join tbl_services ts on tvs.service_id=ts.id where category_id='".$_REQUEST['cid']."' OR vehicle_segment_id='".$_REQUEST['sgid']."' order by amount";
								   ...
								   ?>   
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
                                                <a href="car_detailing_view.php?pid=<?php echo $result6; ?>&sid=<?php echo $result7; ?>&cid=<?php echo $result2; ?>&sgid=<?php echo $result8; ?>"><img src="<?php echo $pl; ?>" alt="<?php echo $Fpl['img_alt']; ?>" title="<?php echo $Fpl['img_title']; ?>" style="height:180px"></a>
                                         ...
                                         <!--         <li class="p_icon"><a href="car_detailing_wish_list_add.php?pid=<?php //echo $result6; ?>&&custid=<?php// echo $_SESSION['customer_id']; ?>"><i class="icon_heart_alt"></i></a></li>        -->                                        
                                                ...
                                                <li>
                                                     ...
                                                     <a class="button one mobile button--secondary deactivate inactive" href="car_detailing_wish_list_add.php?pid=<?php echo $result6; ?>&&custid=<?php echo $_SESSION['customer_id']; ?>">                                                  													  
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <li class="page-item next"><a class="page-link" href="car_detailing.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
									<?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="car_detailing.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>">
									...
									<?php endfor;  ?>									                                   
                                      <li class="page-item next"><a class="page-link" href="car_detailing.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>&city=<?php echo $_REQUEST['city']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
                                ...
                                <aside class="l_widget l_feature_widget">
                                    <div class="verticalCarousel">
                                        ...
                                        //Listing Feature Products Start
                                          $qfp="select * from  tbl_vendor_services LEFT JOIN tbl_vendor ON tbl_vendor.vendor_id=tbl_vendor_services.vendor_id WHERE tbl_vendor_services.category_id='".$_REQUEST['cid']."' AND tbl_vendor.city='".$_REQUEST['city']."' order by id desc limit 0 ,10";
