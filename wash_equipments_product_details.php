...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="car_wash_equipments_details_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Wash Equipments Product Details</h3>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Shop</a></li>
                        <li class="current"><a href="product-details2.html">Buy Wash Equipments</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <?php	
            ...
            $qe="select * from  tbl_products where category_id='14' order by product_title LIMIT $start, $limit";
			$Eqe=mysqli_query($conn,$qe);
			$sizeProducts=mysqli_num_rows($Eqe);


            $result1 ="SELECT count(product_title) AS id FROM tbl_products Where category_id='14'";
...
for ($x = 0; $x < $arrlength; $x++) {
   $arr2[$x]."<br>";
   	            ...
   	            $spv="select * from tbl_products where  MATCH (product_title) AGAINST ('$arr2[$x]') AND category_id='14' ";
            ...
            <div class="container">
                <div class="related_product_inner">
                    ...
                    <div class="row">
					  ...
					  $spv="select * from tbl_products where MATCH (product_title) AGAINST ('$id') AND category_id='14'";
					  $Espv=mysqli_query($conn,$spv);
					  ...
					  ?>
                        <div class="col-lg-3 col-sm-6">
                            <div class="l_product_item">
                                <div class="l_p_img">
                                  <a href="wash_equipments_product_details.php?pid=<?php echo $resultProducts["product_id"]; ?>&vid=<?php echo $resultProductsVendor['vendor_id']; ?>&pvid=<?php echo $resultProductsVendor['id'];?>"><img src="<?php echo $resultProducts["photo"]; ?>" style="height:220px" alt=""></a>									
                                    <h5 class="new" hidden>Service</h5>									
                                </div>
                                <div class="l_p_text">
                                    <ul>
                                      <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                      <li><a class="add_cart_btn" href="wash_equipments_product_details?pid=<?php echo $resultProducts["product_id"]; ?>&vid=<?php echo $resultProductsVendor['vendor_id']; ?>&pvid=<?php echo $resultProductsVendor['id'];?>">View</a></li>
