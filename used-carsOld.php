          ...
          <script>
			 ...
			 function WishList(){               
              ...
              $.ajax({
               ...
               data: {like:prodid,like1:customid,category:cateid},
								   ...
								   ?>   
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
                                                <a href="product-details.php?pid=<?php echo $result5; ?>"><img src="admin/dist/uploads/<?php echo $result1; ?>" alt="<?php echo $Fpl['img_alt']; ?>" title="<?php echo $Fpl['img_title']; ?>" style="height:180px"></a>
                                                ...
                                                <ul>
                                                   ...
                                                   <!-- <li class="p_icon"><a href="used_car_wish_list_add.php?pid=<?php // echo $result5; ?>&&custid=<?php // echo $_SESSION['customer_id']; ?>"><i class="icon_heart_alt"></i></a></li> -->
                                                    ...
                                                    <li>
                                                     ...
                                                     <a class="button one mobile button--secondary deactivate inactive" onClick="WishList()">                                                  													  
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                    <?php for($i = 1; $i<= $pages; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="used-cars.php?page=<?php echo $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>">
									  <?php 
									  if($_REQUEST['page']==$i)
									  {
									  ?>
