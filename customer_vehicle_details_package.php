	    ...
	    <?php 	 
		  ...
		  $FEapo=mysqli_fetch_array($Eapo);
		     ...
		     $FEcn=mysqli_fetch_array($Ecn);
				...
				$vs= "SELECT * FROM tbl_packages WHERE package_no='".$FEapo['service_order_no']."' AND vendor_id='".$FEapo['vendor_id']."' AND  category='".$FEapo['category_id']."' AND vehicle_segment='".$FEsg['id']."'";
				$Evs=mysqli_query($conn,$vs);
		        $FEvs=mysqli_fetch_array($Evs);
				
				    $ps="SELECT * FROM tbl_packages_services WHERE package_no='".$FEvs['package_no']."'";
					$Eps=mysqli_query($conn,$ps);
		            while($FEps=mysqli_fetch_array($Eps)){											
						
					  $si="SELECT * FROM tbl_services WHERE id='".$FEps['service']."'";
		            ...
		            $FEsiw=mysqli_fetch_array($Esiw);
					    ...
					    $tm="SELECT * FROM `tbl_model` WHERE id='".$FEsiw['model']."'";
	       ...
	       $amount =  $FEvs['package_amount'];
		   $package_name=$FEvs['package_name'];
		   $package_id=$FEvs['id'];
		   //$service_name=$FEsi['service_name'];
        ...
        <section class="contact_area p_100">
            <div class="container">
                <div class="contact_title">
                  <h1>Get Vehicle Details - Pacakge Service</h1>
				   <div>&nbsp;</div>
				 ...
				 <div class="contact_form_inner" id="divInv" style="display:none">
                    <form class="contact_us_form row" action="customer_vehicle_details_package_act.php" method="post">
                    ...
                    <div class="form-group-control col-lg-3">
						<label><b>Pacakge Name : </b></label>
						<input type="text" class="form-control" id="package_name" name="package_name" value="<?php echo $package_name; ?>" placeholder="Package Name" required readonly>
                        <input type="text" class="form-control" id="package_id" name="package_id" value="<?php echo $package_id; ?>" placeholder="Package Name" required readonly hidden>
					 </div>
				  ...
				  <form class="contact_us_form row" action="customer_vehicle_details_package_act.php" method="post">
				   <div class="form-group-control col-lg-3" >
                     ...
                     <div class="form-group-control col-lg-3">
						<label><b>Pacakge Name : </b></label>
						<input type="text" class="form-control" id="package_name" name="package_name" value="<?php echo $package_name; ?>" placeholder="Vehicle Number" required readonly>
                        <input type="text" class="form-control" id="package_id" name="package_id" value="<?php echo $package_id; ?>" placeholder="Vehicle Number" required readonly hidden>
					 </div>
                     ...
                     <div class="form-group-control col-lg-3" >
                      ...
                      <div class="form-group col-lg-12">                     
                         <button  class="btn btn-primary" id="form2" name="form2" type="submit">Add To Pacakge</button>
					  </div>
					  </form>
				</div>  
				</div>  
