		...
		<head>
		 ...
		 <title>Special Offers | MyAutoCart</title>       
		...
		<section class="gift_card_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Special Offers</h3>
                    <ul>
                       <li><a href="index.php">Home</a></li>
                       <li><a href="Special_Package_Offers.php">special package offers</a></li>
                    </ul>
                </div>
            </div>
        </section>
        ...
        <section class="contact_area p_100">
            <div class="container">
				...
				<a href="Special_Package_Offers.php" ><img src="img/package/offers_3month.jpg"alt="" title="special offers"></a>
                <div>&nbsp;</div>
				<a href="Special_Package_Offers.php" ><img src="img/package/offers_6month.jpg" alt="" title="special offers"></a>
				<div>&nbsp;</div>
				<a href="Special_Package_Offers.php" ><img src="img/package/offers_1year.jpg" alt="" title="special offers"></a>
				<div>&nbsp;</div>
                <a href="Special_Package_Offers.php" ><img src="img/package/sanitize.jpg" alt="" title="special offers"></a>
				<div>&nbsp;</div>
                <a href="Special_Package_Offers.php" ><img src="img/package/sanitize2.jpg" alt="" title="special offers"></a>
				<div>&nbsp;</div>
				</div>				
