	 ...
	 if(isset($_POST['form1'])) {	               
		...
		$fy="INSERT INTO financial_year SET year_id='".$_POST['year_id']."',financial_year='".$_POST['financial_year']."',start_date='".$_POST['start_date']."',end_date='".$_POST['end_date']."',status='".$_POST['status']."'";
		$Efy=mysqli_query($conn,$fy);
		
		$ug="update tbl_number_generate set fy=fy+1 where Id=1";
        $Eug=mysqli_query($conn,$ug); 		
	
    	$success_message = 'Financial Year is added successfully.';
	 ...
	 ?>
	    <?php
	      //Get Financial Year id------------------------------------
             $fi="select * from tbl_number_generate where id='1'";
             $Efi=mysqli_query($conn,$fi);
             $Ffi=mysqli_fetch_array($Efi);
                  ...
                  <div class="card-body">
                    <div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" name="year_id" id="year_id" value="<?php echo $yearid; ?>" class="form-control" readonly>
                      </div>
                    </div>				  
					...
					<div class="form-group row mb-4">
                      ...
                      <div class="col-sm-12 col-md-7">
                        <input type="text" id="financial_year" name="financial_year" placeholder="Financial Year" class="form-control" required>
                      </div>
                    </div>								
