        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="expense_type.php" class="btn btn-primary">Add New</a>
            </div>
          ...
          <div class="section-body">
              ...
              <div class="col-12">
                <div class="card">
	             ...
	             <div class="float-right">
                      <form action="expense_type_view.php" method="post">
                        <div class="input-group">
                       <input type="text" id="search" name="search" class="form-control" value="<?php echo $_REQUEST['search'] ?>" onkeyup="this.value.function()" placeholder="Search by Type" title="Type a Expense Type">                                                        
                         ...
                         <tr>
				          ...
				          <th hidden>Action</th> 
								...
								$i1=0;
								  ...
								  if($_POST['search']!='')
								  {
								  $pl="SELECT * FROM tbl_expense_type  where expense_type LIKE '$skey' ";
								  $Epl=mysqli_query($conn,$pl);						  									   									 									  							    
								  }
								  else
								  {
								  $pl="SELECT * FROM tbl_expense_type  ORDER BY id ASC LIMIT $start, $limit";
								  $Epl=mysqli_query($conn,$pl);								  									   									 									  							    
								  }
								    ...
								    while($FEslg=mysqli_fetch_array($Epl))
								     {
										   ...
										   $svm="SELECT count(id) AS total_count_expense_type FROM tbl_expense_type";
					       ...
					       $FElg=mysqli_fetch_array($Elg);
										  ...
										  $result1 ="SELECT count(id) AS id FROM tbl_expense_type";
            ...
            $total_count_pages= $pages;						  
	     	$total_count_expense_type=$FEsvm['total_count_expense_type'];
					   ...
					   <tbody>
						...
						<?php } ?>					   
								...
								<li>	<b>No of Expense Type :  <?php echo $total_count_expense_type;  ?></b></li>
			<!-- Dynamic Pagination -->                                                              
                                <div class="card-body float-right">
                                  <nav aria-label="Page navigation example">
                                    <ul class="pagination">                                   
									 <li class="page-item active"><a class="page-link" href="expense_type_view.php?page=<?= $Previous; ?>">Previous </a></li>
                                     <?php for($i = 1; $i<= $page; $i++) : ?>
									 <li class="page-item"><a class="page-link" href="expense_type_view.php?page=<?= $i; ?>">
                                     ...
                                     <?php endfor;  ?>	
									 <li class="page-item active"><a class="page-link" href="expense_type_view.php?page=<?php echo $Next; ?>">Next</a></li>
                                    </ul>
                                   </nav>
                                </div>                               
