...
if (!$email) {
	...
	$sel_query = "SELECT * FROM `user_create` WHERE email='".$email."'";
...
$output.='<p>-------------------------------------------------------------</p>';
$output.='<p><a href="https://myautocart.com/admin/dist/reset_password.php?key='.$key.'&email='.$email.'&action=reset" target="_blank">https://myautocart.com/admin/dist/reset_password.php?key='.$key.'&email='.$email.'&action=reset</a></p>';		
$output.='<p>-------------------------------------------------------------</p>';
...
header('location:login.php?success= The password reset link sending your email.');
		}	 		
} 
...
<head>
  ...
  <title>Forgot Password &mdash; MyAutoCart</title>
