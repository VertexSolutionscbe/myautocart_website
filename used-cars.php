	  ...
	  <head>
        ...
        <?php
		 $tg="SELECT * FROM tbl_seo_tags WHERE webpage='used-cars.php'";
      ...
      <!--- Heade Area End --->	
          ...
          <script>
            ...
            $.ajax({
              type:'post',
               url:'aj_usedcars_price_filter.php',// put your real file name 
        ...
        <section class="usedcars_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Used Cars in India</h3>
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li hidden><a href="#">Used Cars</a></li>
                        <li class="current"><a href="#">Used Cars</a></li>
                    </ul>
                </div>
            </div>
        </section>
						...
						<div class="alert alert-success alert-dismissible" role="alert">
							...
							Item Added in your Wish list !
                                ...
                                <div class="row" name="disprow" id="disprow">
								  <?php
								    while($Fpl=mysqli_fetch_array($Epl))
								     ...
								     $i1++;
								   ?>   
                                    <div class="col-lg-4 col-sm-6" id="products">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
                                                <a href="product-details.php?pid=<?php echo $result5; ?>"><img src="<?php echo $result1; ?>" alt="<?php echo $Fpl['img_alt']; ?>" title="<?php echo $Fpl['img_title']; ?>" style="height:180px" width="100%"></a>
                                                <h5 class="sale"><?php echo $Fpl['status']; ?></h5>
                                            </div>
                                            <div class="l_p_text">
                                                <ul>
                                                    <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                                                    <li><a class="add_cart_btn" href="product-details.php?pid=<?php echo $result5; ?>&sid=<?php echo $segment1; ?>&cid=<?php echo 2; ?>">View</a></li>
								...
								<nav aria-label="Page navigation example" class="pagination_area">
                                  <ul class="pagination">								  
				                   <li class="page-item next"><a class="page-link" href="used-cars.php?page=<?= $Previous; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-left" aria-hidden="true"></i></a></li> 
								      <?php for($i = 1; $i<= $page; $i++) : ?>
                                      <li class="page-item"><a class="page-link" href="used-cars.php?page=<?= $i; ?>&cid=<?php echo $_REQUEST['cid']; ?>">
									 ...
									 <?php endfor;  ?>									                                   
                                    <li class="page-item next"><a class="page-link" href="used-cars.php?page=<?php echo $Next; ?>&cid=<?php echo $_REQUEST['cid']; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
								  </ul>
                                </nav>								
                                    ...
                                    <ul class="navbar-nav">                                        
                                        <li class="nav-item dropdown">
											...
											<?php
									         ...
									         ?>                                              												
												 <?php if($segment_id=='1'){ ?>
									                <li class="nav-item"><a class="nav-link" href="used-cars.php?sid=<?php echo $segment_id; ?>&sname=<?php echo $segment_name; ?>"><?php echo $segment_name; ?></a></li>
									             <?php } ?>
									             <?php if($segment_id=='2') { ?>
									                <li class="nav-item"><a class="nav-link" href="used-cars.php?sid=<?php echo $segment_id; ?>&sname=<?php echo $segment_name; ?>"><?php echo $segment_name; ?></a></li>
									             <?php } ?>
                                ...
                                <aside class="l_widget l_feature_widget">
                                    <div class="verticalCarousel">
                                        ...
                                        //Listing Feature Products Start
                                          $qfp="select * from  tbl_products where product_status='Active' order by product_id desc limit 4 ,14";
                                        ...
                                        <ul class="verticalCarouselGroup vc_list">
                                            ...
                                            <li>
                                                <div class="media">
                                                    <div class="d-flex">
                                                        <a href="product-details.php?pid=<?php echo $resultFProducts["product_id"]; ?>"><img src="<?php echo $imageurl.$resultFProducts["photo"]; ?>" width="100px" height="70px" alt=""></a>
                                                    </div>
