		...
		<head>
		 ...
		 <title>Services Wish List | MyAutoCart</title>      
    ...
    // location.replace("register.php")
     ...
     return false; 
        ...
        <section class="service_wishlist_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Service Wish List</h3>
                     <ul>
                       <li><a href="index.php">Home</a></li>
                       <li hidden><a href="#">Service Wish List</a></li>
                       <li class="current"><a href="#">Service Wish List</a></li>
                     </ul>
                </div>
            </div>
        </section>
								   ...
								   ?>   
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="l_product_item">
                                            <div class="l_p_img">
											   <a href="service-remove.php?sid=<?php echo $result5; ?>&&custid=<?php echo $_SESSION['customer_id']; ?>"><img src="img/icon/close-icon.png" align="right" alt=""></a>
