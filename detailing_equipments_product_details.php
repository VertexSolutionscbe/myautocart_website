...
function myFunction() {
  ...
  if (x)
    ...
    return false;
        ...
        <section class="car_detailing_equipments_product_details_banner_area">
            <div class="container">
                <div class="c_banner_inner">
                    <h3>Buy Cars Detailing Equipments</h3>
                    <ul>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">Shop</a></li>
                        <li class="current"><a href="detailing_equipments_product_details.php">Cars Detailing Equipments</a></li>
                    </ul>
                </div>
            </div>
        </section>
