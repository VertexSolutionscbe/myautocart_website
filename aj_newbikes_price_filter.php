		   ...
		   ?>   
			<div class="col-lg-4 col-sm-6">
              <div class="l_product_item">
                <div class="l_p_img">
                  <a href="product-details.php?pid=<?php echo $result5; ?>"><img src="<?php echo $result1; ?>" alt="" style="height:180px"></a>
                  <h5 class="new" hidden>New</h5>
                </div>
                <div class="l_p_text">
                 <ul>
                   <li class="p_icon"><a href="#"><i class="icon_piechart"></i></a></li>
                   <li><a class="add_cart_btn" href="new-bikes-product-details.php?pid=<?php echo $result5; ?>">View</a></li>
		 ...
		 <nav aria-label="Page navigation example" class="pagination_area">
		  <ul class="pagination">							  
			<?php for($i = 1; $i<= $pagesa; $i++) : ?>
			  <li class="page-item"><a class="page-link" href="new-bikes.php?page=<?php echo $i; ?>&cid=<?php echo $cat; ?>"><?php echo $i; ?></a></li>
			<?php endfor;  ?>									                                   
			  <li class="page-item next"><a class="page-link" href="new-bikes.php?pagesa=<?php echo $Next; ?>&cid=<?php echo $cat; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i></a></li>                                    								  
		  </ul>
		</nav>								
